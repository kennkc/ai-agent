...
| 4 | **`proto契约使用说明.md`** | 6 份 proto 怎么用？现在到底有没有被调用？改了契约要动哪几步？ |
| 5 | `java-services/` | 每个 Java 源文件是干什么的？改这里要注意什么？ |
| 6 | `项目进度日志报告/` | 每个阶段具体做了哪些事、遇到什么问题、怎么解决的？ |
| 7 | `demo/` | 怎么把系统跑起来、怎么亲眼看到效果？ |
| 8 | `优化日志/` | 每轮工程化加固改了什么、为什么改？ |
