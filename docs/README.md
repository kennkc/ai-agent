...
| 7 | `java-services/` | 每个 Java 源文件是干什么的？改这里要注意什么？ |
| 8 | `项目进度日志报告/` | 每个阶段具体做了哪些事、遇到什么问题、怎么解决的？ |
| 9 | `demo/` | 怎么把系统跑起来、怎么亲眼看到效果？ |
| 10 | `优化日志/` | 每轮工程化加固改了什么、为什么改？ |
| 11 | `../db/` | 数据存在哪？表/键/向量集合结构是什么？怎么备份恢复？ |
