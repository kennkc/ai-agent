...
| 6 | **`模型接入配置-功能逻辑.md`** | 前台配一个模型到被真正调用，中间经过了什么？密钥怎么存？角色怎么装配？ |
| 7 | **`Phase6-前置设计冻结稿.md`** | Phase 6 暂不开发时，DAG、状态机、工件和验收门先冻结成什么？ |
| 8 | **`部署与环境版本基线.md`** | 本机/CI/生产需要哪些版本、生产路由和 fail-closed 配置怎么设？ |
| 9 | `java-services/` | 每个 Java 源文件是干什么的？改这里要注意什么？ |
| 10 | `项目进度日志报告/` | 每个阶段具体做了哪些事、遇到什么问题、怎么解决的？ |
| 11 | `demo/` | 怎么把系统跑起来、怎么亲眼看到效果？ |
| 12 | `优化日志/` | 每轮工程化加固改了什么、为什么改？ |
| 13 | `../db/` | 数据存在哪？表/键/向量集合结构是什么？怎么备份恢复？ |
...
| `Phase6-必需端点排期冻结稿.md` · `.html` | **Phase 6 planned 端点优先级**：blocking / enabling / deferred 三层与解冻条件 | Phase 6 解冻前评审时 |
| `Phase6-前置设计冻结稿.md` · `.html` | **Phase 6 前置设计冻结**：DAG、节点状态机、协作消息、工件、验收门与 MC-01/WB-10/tool-executor 边界；明确不含 Phase 6 代码实现 | Phase 6 解冻前评审时 |
