...
const overview = {
  ...
  summary: {
    ...
    avg_latency_ms: 120, max_latency_ms: 800, http_p95_ms: 250, jvm_heap_used_bytes: 512 * 1024 * 1024,
    jvm_heap_max_bytes: 1024 * 1024 * 1024, jvm_heap_used_ratio: 0.5, jvm_threads: 80,
    gc_pause_avg_ms: 3, gc_pause_max_ms: 12, gc_p95_ms: 8, hikari_active: 4, hikari_max: 10, hikari_pending: 0,
  ...
  services: [{ job: 'gateway-service', health: 'up', qps: 10, error_rate: 0, avg_latency_ms: 20, max_latency_ms: 80, http_p95_ms: 60, heap_used_bytes: 100, heap_max_bytes: 200, heap_used_ratio: 0.5, threads: 20, hikari_active: 2, hikari_max: 5, hikari_pending: 0, gc_p95_ms: 8 }],
