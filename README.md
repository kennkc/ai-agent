...
三个长期分支自 2026-09-16 起**内容对齐、指向同一提交**，任选其一接续开发即可：

| 分支 | 用途 |
|---|---|
| `workbuddy/main` | 主开发线（Phase 0/1/2 + 工作平台 + Java 文档集） |
| `codex/phase0-1-hardening` | 与主开发线同内容，保留该名以延续既有工作流 |
| `dev` | 集成分支，与主开发线同内容，快进对齐 |
